...
const WorkWithUs = () => {
  return (
    <div className="max-w-[1500px] h-full md:h-[100vh] mx-auto gap-5 md:gap-15  py-6  md:px-[15%] flex flex-col md:flex-row justify-between items-center gap-5 my-10 bg-gray-50/75">
